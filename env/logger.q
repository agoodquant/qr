...
m["d"]:{[x;y]string .z.d};
m["t"]:{[x;y]string .z.t};
l:{TRACE_DEBUG:`disable; ssr/[fm;"%",/:lfm;m[lfm:raze -1_/:2_/:nl where fm like/: nl:"*%",/:(.Q.a,.Q.A),\:"*"].\:(x;y)]};
p:{TRACE_DEBUG:`disable; $[10h~type x:(),x;x;(2~count x) & 10h~type x 0;ssr/[x 0;"%",/:string 1+til count (),x 1;.Q.s1 each (),x 1];.Q.s1 x]};
